...
public class StreetLocalServiceWrapper
	...
	public StreetLocalServiceWrapper() {
		this(null);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _streetLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _streetLocalService.dslQueryCount(dslQuery);
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _streetLocalService.getBasePersistence();
	}
