...
public abstract class PolicyCoverageOptLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyCoverageOptLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>hr.crosig.proposal.service.PolicyCoverageOptLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return policyCoverageOptPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PolicyCoverageOptLocalServiceImpl#deletePolicyCoverageOpt(PolicyCoverageOpt) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PolicyCoverageOptLocalServiceBaseImpl.class);
