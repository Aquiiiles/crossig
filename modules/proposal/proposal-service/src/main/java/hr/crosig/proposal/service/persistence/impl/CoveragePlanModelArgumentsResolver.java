...
import hr.crosig.proposal.model.CoveragePlanTable;
...
/**
 * The arguments resolver class for retrieving value from CoveragePlan.
 *
...
@Component(
	property = {
		"class.name=hr.crosig.proposal.model.impl.CoveragePlanImpl",
		"table.name=AP_Proposal_CoveragePlan"
	},
	service = ArgumentsResolver.class
)
public class CoveragePlanModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getClassName() {
		return CoveragePlanImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return CoveragePlanTable.INSTANCE.getTableName();
	}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = coveragePlanModelImpl.getColumnValue(columnName);
			}
		}
