...
/**
 * The arguments resolver class for retrieving value from PolicyCoverageOpt.
 *
...
@Component(
	property = {
		"class.name=hr.crosig.proposal.model.impl.PolicyCoverageOptImpl",
		"table.name=AP_Proposal_PolicyCoverageOpt"
	},
	service = ArgumentsResolver.class
)
public class PolicyCoverageOptModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(policyCoverageOptModelImpl, columnNames, original);
		}
	...
	public String getClassName() {
		return PolicyCoverageOptImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return PolicyCoverageOptTable.INSTANCE.getTableName();
	}
