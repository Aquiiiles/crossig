...
public abstract class CoveragePlanLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CoveragePlanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>hr.crosig.proposal.service.CoveragePlanLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return coveragePlanPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CoveragePlanLocalServiceImpl#deleteCoveragePlan(CoveragePlan) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CoveragePlanLocalServiceBaseImpl.class);
