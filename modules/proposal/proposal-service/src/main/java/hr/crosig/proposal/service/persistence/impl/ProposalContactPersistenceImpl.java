...
public class ProposalContactPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new ProposalContactModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", ProposalContact.class.getName()));
		...
		_setProposalContactUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setProposalContactUtilPersistence(null);
	...
	private void _setProposalContactUtilPersistence(
		ProposalContactPersistence proposalContactPersistence) {

		try {
			Field field = ProposalContactUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, proposalContactPersistence);
		}
	...
	private static class ProposalContactModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					proposalContactModelImpl, columnNames, original);
			}
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						proposalContactModelImpl.getColumnOriginalValue(
							columnName);
				}
				else {
