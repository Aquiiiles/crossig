...
import hr.crosig.proposal.service.PolicyOptionsLocalServiceUtil;
...
/**
 * Provides the base implementation for the policy options local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link hr.crosig.proposal.service.impl.PolicyOptionsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see hr.crosig.proposal.service.impl.PolicyOptionsLocalServiceImpl
 * @generated
 */
public abstract class PolicyOptionsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyOptionsLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyOptionsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PolicyOptionsLocalServiceUtil</code>.
	 */
	...
	public PolicyOptions createPolicyOptions(long policyOptionsId) {
		return policyOptionsPersistence.create(policyOptionsId);
	}
	...
	public PolicyOptions deletePolicyOptions(long policyOptionsId)
		...
		return policyOptionsPersistence.remove(policyOptionsId);
	}
	...
	public PolicyOptions deletePolicyOptions(PolicyOptions policyOptions) {
		return policyOptionsPersistence.remove(policyOptions);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PolicyOptions.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return policyOptionsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return policyOptionsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return policyOptionsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return policyOptionsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PolicyOptions fetchPolicyOptions(long policyOptionsId) {
		return policyOptionsPersistence.fetchByPrimaryKey(policyOptionsId);
	}
	...
	public PolicyOptions getPolicyOptions(long policyOptionsId)
		...
		return policyOptionsPersistence.findByPrimaryKey(policyOptionsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(policyOptionsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PolicyOptions.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("policyOptionsId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			policyOptionsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PolicyOptions.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return policyOptionsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return policyOptionsLocalService.deletePolicyOptions(
			(PolicyOptions)persistedModel);
	}

	public BasePersistence<PolicyOptions> getBasePersistence() {
		return policyOptionsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return policyOptionsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PolicyOptions> getPolicyOptionses(int start, int end) {
		return policyOptionsPersistence.findAll(start, end);
	}
	...
	public int getPolicyOptionsesCount() {
		return policyOptionsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyOptionsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		policyOptionsLocalService = (PolicyOptionsLocalService)aopProxy;

		_setLocalServiceUtilService(policyOptionsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyOptionsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = policyOptionsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PolicyOptionsLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, policyOptionsLocalService);
		}
	...
	protected PolicyOptionsLocalService policyOptionsLocalService;
