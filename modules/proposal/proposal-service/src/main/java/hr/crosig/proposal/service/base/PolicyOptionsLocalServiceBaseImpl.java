...
public abstract class PolicyOptionsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyOptionsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>hr.crosig.proposal.service.PolicyOptionsLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return policyOptionsPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PolicyOptionsLocalServiceImpl#deletePolicyOptions(PolicyOptions) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PolicyOptionsLocalServiceBaseImpl.class);
