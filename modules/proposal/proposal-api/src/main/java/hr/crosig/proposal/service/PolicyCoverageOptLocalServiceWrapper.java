...
public class PolicyCoverageOptLocalServiceWrapper
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _policyCoverageOptLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _policyCoverageOptLocalService.dslQueryCount(dslQuery);
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _policyCoverageOptLocalService.getBasePersistence();
	}
