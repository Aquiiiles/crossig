...
public class ProductLocalServiceWrapper
	...
	public hr.crosig.proposal.model.Product addProduct(
		hr.crosig.proposal.model.Product product) {
	 ...
	 */
	@Override
	public hr.crosig.proposal.model.Product createProduct(long productId) {
	 ...
	 */
	@Override
	public hr.crosig.proposal.model.Product deleteProduct(long productId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public hr.crosig.proposal.model.Product deleteProduct(
		hr.crosig.proposal.model.Product product) {
	...
	@Override
	public hr.crosig.proposal.model.Product fetchProduct(long productId) {
	 ...
	 */
	@Override
	public hr.crosig.proposal.model.Product getProduct(long productId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<hr.crosig.proposal.model.Product> getProducts(
		int start, int end) {
	...
	public java.util.List<hr.crosig.proposal.model.Product> getProducts(
		...
		return _productLocalService.getProducts(roleId);
	}
	 ...
	 */
	@Override
	public hr.crosig.proposal.model.Product updateProduct(
		hr.crosig.proposal.model.Product product) {
