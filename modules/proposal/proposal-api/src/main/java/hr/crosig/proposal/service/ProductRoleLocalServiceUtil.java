...
/**
 * Provides the local service utility for ProductRole. This utility wraps
 * <code>hr.crosig.proposal.service.impl.ProductRoleLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProductRoleLocalServiceUtil {
	 ...
	 */
	public static ProductRole addProductRole(ProductRole productRole) {
		return getService().addProductRole(productRole);
	}
	 ...
	 */
	public static ProductRole createProductRole(long productRoleId) {
		return getService().createProductRole(productRoleId);
	}
	 ...
	 */
	public static ProductRole deleteProductRole(long productRoleId)
		throws PortalException {

		return getService().deleteProductRole(productRoleId);
	}
	 ...
	 * @return the product role that was removed
	 */
	public static ProductRole deleteProductRole(ProductRole productRole) {
		return getService().deleteProductRole(productRole);
	}
	...
	public static ProductRole fetchProductRole(long productRoleId) {
		return getService().fetchProductRole(productRoleId);
	}
	 ...
	 * @throws PortalException if a product role with the primary key could not be found
	 */
	public static ProductRole getProductRole(long productRoleId)
		throws PortalException {

		return getService().getProductRole(productRoleId);
	}
	 ...
	 */
	public static List<ProductRole> getProductRoles(int start, int end) {
		return getService().getProductRoles(start, end);
	}
	 ...
	 */
	public static int getProductRolesCount() {
		return getService().getProductRolesCount();
	}
	 ...
	 */
	public static ProductRole updateProductRole(ProductRole productRole) {
		return getService().updateProductRole(productRole);
	}

	public static ProductRoleLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<ProductRoleLocalService> _serviceSnapshot =
		new Snapshot<>(
			ProductRoleLocalServiceUtil.class, ProductRoleLocalService.class);
