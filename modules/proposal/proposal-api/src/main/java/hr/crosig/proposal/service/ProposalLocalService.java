...
public interface ProposalLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>hr.crosig.proposal.service.impl.ProposalLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the proposal local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProposalLocalServiceUtil} if injection and service tracking are not available.
	 */
