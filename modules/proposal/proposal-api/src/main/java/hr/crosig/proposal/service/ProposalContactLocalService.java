...
/**
 * Provides the local service interface for ProposalContact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProposalContactLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProposalContactLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>hr.crosig.proposal.service.impl.ProposalContactLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the proposal contact local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProposalContactLocalServiceUtil} if injection and service tracking are not available.
	 */
